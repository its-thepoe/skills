...
> **Truth order:** [Framer’s developer docs](https://www.framer.com/developers/) and the **`framer-plugin`** types on npm override this file when they disagree. Use this file for fast agent context. Link index + refresh commands: [framer-official-docs.md](framer-official-docs.md).
...
- [Developers hub](https://www.framer.com/developers/)
