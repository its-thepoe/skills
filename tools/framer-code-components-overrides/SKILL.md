...
description: >-
  Framer site canvas only: Code Components and Code Overrides (React on canvas),
  addPropertyControls, withFeatureName HOCs, Framer Motion, WebGL/shaders,
  RenderTarget, SSR/hydration, fonts, esm.sh. Use when editing Framer canvas
  code or debugging Framer canvas runtime. Not for Framer Plugin SDK, ManagedCollection,
  or npm create framer-plugin projects — use framer-plugins instead.
argument-hint: "[file-or-topic]"
---

# Framer Code Development

**Source:** [fredm00n/framerlabs](https://github.com/fredm00n/framerlabs) (MIT). **Scope:** canvas Code Components / Overrides only — not plugins.

**Official Framer docs (always check for API changes):** [references/framer-official-docs.md](references/framer-official-docs.md) — hub, Components reference, comparison with Plugins/Fetch, changelog, npm `framer`, and a shell recipe to re-download the framerlabs mirror.
...
- **[framer-official-docs.md](references/framer-official-docs.md)** — Official Framer URLs + refresh from framerlabs
- **[property-controls.md](references/property-controls.md)** — Control types and patterns
- **[patterns.md](references/patterns.md)** — Shared state, scroll, magnetic hover, etc.
- **[webgl-shaders.md](references/webgl-shaders.md)** — WebGL / shaders on canvas
